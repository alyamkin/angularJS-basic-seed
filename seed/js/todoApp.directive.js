function todoApp() {
  return {
    ...
    template: `
      <div class="todo">
      <form class="todo__form" ng-submit="todo.addNewTodo();">
        <input
          type="text"
      ...
      <ul class="todo__list">
        <li ng-repeat="item in todo.list ">
          ...
          <input type="text" ng-model="item.title" ng-show="showEditField" ng-blur="todo.updateTodo(item, $index); showEditField = false" todo-autofocus="showEditField">
      ...
      <p class="todo__remaining">
        ...
        <span ng-show="todo.getRemaining().length === 0">You are super productive!</span>
      </p>
    </div>
    `,
  };
